        ...
        <div className="max-w-4xl mx-auto px-4 py-12 md:py-16">
            ...
            <div className="bg-white p-8 md:p-12 rounded-lg">
                <div className="prose prose-blue max-w-none text-gray-700 leading-relaxed">
                    <p>Rising卓球教室（以下，「当社」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。</p>
                    ...
                    <div>当社が個人情報を収集・利用する目的は，以下のとおりです。
                        <ul>
                    ...
                    <ul>
                        <li>ユーザーは，当社の保有する自己の個人情報が，利用目的の範囲を超えて取り扱われているという理由，または不正の手段により取得されたものであるという理由により，その利用の停止または消去（以下，「利用停止等」といいます。）を求めることができます。</li>
